...
?>
<form method="post">
	<input type="hidden" value=<?php echo $isUpdate ?> name="isUpdate">
	<div class="modal-body">
		<div>
			<label for="txtUName" class="col-sm-4 control-label">Book Code</label>
			<div>
				<input type="text" class="form-control" id="txtUName" placeholder="Code" name="txtBookCode" value="<?php echo getInfo('BookCode',$row) ?>"  <?php echo getInfo('BookCode',$row)!="" ? "readonly":"" ?>/>
			</div>
		</div>
		<br>
		<div>
